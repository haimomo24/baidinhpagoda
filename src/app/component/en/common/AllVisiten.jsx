...
const blogs = [
   {
    ...
    title: "Tuyet Tinh Coc",
    link: "https://chuabaidinhnbinh.com/",
  },
  
  
   { img: "/images/DSC00002.JPG", title: "Bai Dinh Pagoda ",link: "/" },
   {
...
const MobileSlider = () => {
  ...
  return (
    <div
      className="relative w-full px-4 block sm:hidden" 
...
const AllVisiten = () => {
  ...
  "
>ATTRACTIVE TOURIST DESTINATIONS</h2>
      </div>
