...
const HotelEng = () => {
  ...
  return (
    <section className="max-w-5xl mx-auto px-4 py-8 font-sans space-y-5">
          <h2 className="text-xl text-gray-700 font-semibold">Rooms and Rates</h2>
          <div className="bg-white border rounded-2xl divide-y divide-gray-100">
            {rooms.length === 0 ? (
              <p className="p-6 text-gray-500 text-center">Loading room list...</p>
            ) : (
              rooms.map((room, idx) => (
                <div
                  key={room.id}
                ...
                >
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-sm text-gray-500">
                      Tổng: {room.total_rooms} room
                    </p>
                    <div className="text-sm text-gray-700">
                      <div>Booked: 09</div>
                      <div>Not booked yet: {room.total_rooms}</div>
                    </div>
