  ...
  return (
    <div className="w-full">
          ...
          <motion.section
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl md:text-4xl font-bold">Hall A</h2>
          ...
          >
            ...
            <div className="w-full md:w-1/2 text-center md:text-left md:px-10">
              <h2 className="text-2xl md:text-4xl font-bold mb-6"> Hall B</h2>
              <p className="text-base md:text-lg leading-relaxed">Acreage: ​​120m²</p>
          ...
          >
            <div className="max-w-lg w-full md:w-1/2 mb-6 md:mb-0">
              ...
              <ul className="space-y-4 md:space-y-6 text-base md:text-lg">
                <li>
                  <span className="font-semibold">•Acreage : 5.000m²</span> <br />
                  
                   Capacity up to 3500 people
                </li>
                <li>
                  <span className="font-semibold">•Suitable for organization </span> <br />
                  international events, festivals and summits
                </li>
                <li>
                  <span className="font-semibold">•Equipment </span> <br />
          ...
          >
            <div className="flex flex-col md:flex-row w-full max-w-5xl gap-8">
              <div className="w-full md:w-1/2 flex flex-col justify-center">
                <h2 className="text-2xl md:text-3xl font-bold mb-4">CONTACT TO BOOK</h2>
